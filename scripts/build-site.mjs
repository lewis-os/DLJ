...
const wordmark = `<span class="wordmark" aria-hidden="true"><span class="wordmark-name">Danika Lewis Journal</span><span class="wordmark-signature"><i>DLJ</i><b>Ideas worth carrying forward</b></span></span>`;
const header = () => `<header class="site-header"><a class="brand" href="${base}/" aria-label="Danika Lewis Journal home">${wordmark}</a><button class="menu" aria-label="Open menu">Menu</button><nav><a href="${base}/#current">Current edition</a><a href="${base}/archive/">Archive</a><a href="${base}/about/">About</a></nav></header>`;
const footer = () => `<footer><div><span class="footer-monogram">DLJ</span><p>A public journal of human-centered reflection by Danika Lewis.</p></div><div class="footer-links"><a href="${site.linkedin}">LinkedIn</a><a href="${site.github}">Source archive</a><a href="${base}/about/">Editorial method</a></div><p class="fine">© 2026 Danika Lewis Journal · Sources and uncertainty are named in every entry.</p></footer>`;
